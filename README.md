...
Snorlax's Cave is a UV built proxy and game site **(v3.0 Release)**
</div>
...
```
# What's new?
### Here's what's new with v3.1.1
- Bug fixes
- CSS fixes
- Changed styling of certain buttons
- reworked some scripts
- Fixed navbar
To see an extended, descriptive list of all changes added, please go to [CHANGELOG.md](https://github.com/Snorlaxs-Cave/Snorlaxs-cave-v3/blob/main/CHANGELOG.md)
